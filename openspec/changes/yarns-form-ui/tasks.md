...
| Suggested split | PR1a S1a (`feature/25-s1a-yarn-save-client`, commit fa12492: createYarn/updateYarn, 292 lines) → PR1b S1b (`feature/25-s1b-upload-client`, base = PR1a: uploadImage + debt 200, 309 lines) — S1 split applied 2026-09-22 after it landed at ≈601 lines → PR2 S2 → PR3 S3 → PR4 S4 → PR5 S5a → PR6 S5b → PR7 S6 → PR8 S7 |
